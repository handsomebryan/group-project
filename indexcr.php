        ...
        function resetForm() {
            ...
            function updateChart(data) {
                ...
                var config = {
                    type: 'bar',
                    data: {
                        labels: data.user.map(d => d.商品英文代碼),
                        datasets: [{
                            label: '客戶序號: ' + (data.user.length > 0 ? data.user[0].要保人序號.slice(-5) : 'N/A') + '',
                                    ...
                                    <div class="form-inline">
                                      <div class="form-group">
                                        <div class="input-group">
                                          <select id="idInput" class="form-select "><option value="id">客戶序號</option></select>
